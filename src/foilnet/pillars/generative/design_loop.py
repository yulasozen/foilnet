"""FOILNET design loop -- the capstone: imagine a hull, get its drag instantly.
...
from foilnet.pillars.generative.pointcloud_vae import PointCloudVAE
from foilnet.pillars.geometry_repr.dataset_pc import POINTCLOUDS_DIR, REPO_ROOT
